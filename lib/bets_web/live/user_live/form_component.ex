    ...
    <div>
      ...
      >
        ...
        <.input
          ...
          options={Ecto.Enum.values(Bets.Accounts.User, :role)}
        />
        <.input field={@form[:game_id]} type="number" label="Game" />
        <.input field={@form[:bet_id]} type="number" label="Bet" />
        <.input field={@form[:admin_id]} type="number" label="Admin" />
        <.input field={@form[:player_id]} type="number" label="Player" />
        <:actions>
