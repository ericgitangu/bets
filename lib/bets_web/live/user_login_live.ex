defmodule BetsWeb.UserLoginLive do
  ...
  def handle_event("handle_github_sign_in", _params, socket) do
    {:noreply, redirect(socket, to: "/auth/github")}
  end
end
